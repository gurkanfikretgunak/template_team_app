...
class _RestClient implements RestClient {
  ...
  @override
  Future<UserRegisterResponse> register(user) async {
  ...
  @override
  Future<UserLoginResponse> login(user) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AddressResponse> getAddress(token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<ShopDetailModel> getShopDetailsById(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ShopDetailModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ShopDetailModel.fromJson(_result.data!);
    return value;
  }
